	...
	.p2align	4, 0x0                          // -- Begin function _RNvCs4tBK5thUKo0_3lib11scalar_loop
	.type	.LCPI0_0,@object
.LCPI0_0:
	.xword	64                              // 0x40
	.xword	128                             // 0x80
...
_RNvCs4tBK5thUKo0_3lib11scalar_loop:    // @_RNvCs4tBK5thUKo0_3lib11scalar_loop
	.cfi_startproc
// %bb.0:                               // %_RINvYINtNtNtCs1JkTRtNJhRR_4core5slice4iter11ChunksExacthENtNtNtNtBa_4iter6traits8iterator8Iterator3zipINtB6_7IterMutyEECs4tBK5thUKo0_3lib.exit
	lsr	x8, x1, #6
	cmp	x8, x3
	csel	x8, x8, x3, lo
	cbz	x8, .LBB0_4
// %bb.1:                               // %bb5.preheader
	...
	stp	d15, d14, [sp, #416]            // 16-byte Folded Spill
	stp	d13, d12, [sp, #432]            // 16-byte Folded Spill
	stp	d11, d10, [sp, #448]            // 16-byte Folded Spill
	stp	d9, d8, [sp, #464]              // 16-byte Folded Spill
	str	x30, [sp, #480]                 // 8-byte Spill
	.cfi_offset w30, -16
	.cfi_offset b8, -24
	.cfi_offset b9, -32
	.cfi_offset b10, -40
...
.LBB0_2:                                // %bb5
	...
	ldp	q7, q6, [sp, #352]              // 32-byte Folded Reload
	ushll	v5.2d, v5.2s, #0
	...
	ldp	q27, q16, [sp, #256]            // 32-byte Folded Reload
	bic	v16.16b, v16.16b, v24.16b
	ldp	q24, q28, [sp, #160]            // 32-byte Folded Reload
	bic	v27.16b, v27.16b, v4.16b
	ldr	q4, [sp, #240]                  // 16-byte Reload
	bic	v20.16b, v24.16b, v20.16b
	ldr	q24, [sp, #192]                 // 16-byte Reload
	...
	ldp	q9, q29, [sp, #32]              // 32-byte Folded Reload
	...
	b.ne	.LBB0_2
// %bb.3:
	ldp	d9, d8, [sp, #464]              // 16-byte Folded Reload
	ldr	x30, [sp, #480]                 // 8-byte Reload
	ldp	d11, d10, [sp, #448]            // 16-byte Folded Reload
	ldp	d13, d12, [sp, #432]            // 16-byte Folded Reload
	ldp	d15, d14, [sp, #416]            // 16-byte Folded Reload
	add	sp, sp, #496
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        // -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          // -- Begin function _RNvCs4tBK5thUKo0_3lib15to_bitmask_loop
	.type	.LCPI1_0,@object
.LCPI1_0:
	.byte	1                               // 0x1
	.byte	2                               // 0x2
...
_RNvCs4tBK5thUKo0_3lib15to_bitmask_loop: // @_RNvCs4tBK5thUKo0_3lib15to_bitmask_loop
	.cfi_startproc
// %bb.0:                               // %start
	lsr	x8, x1, #6
	cmp	x8, x3
...
.Lfunc_end1:
	...
	.cfi_endproc
                                        // -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          // -- Begin function _RNvCs4tBK5thUKo0_3lib17to_bitmask32_loop
	.type	.LCPI2_0,@object
.LCPI2_0:
	.byte	1                               // 0x1
	.byte	2                               // 0x2
...
_RNvCs4tBK5thUKo0_3lib17to_bitmask32_loop: // @_RNvCs4tBK5thUKo0_3lib17to_bitmask32_loop
	.cfi_startproc
// %bb.0:                               // %start
	lsr	x8, x1, #6
	cmp	x8, x3
...
.Lfunc_end2:
	...
	.cfi_endproc
                                        // -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4, 0x0                          // -- Begin function _RNvCs4tBK5thUKo0_3lib9neon_loop
	.type	.LCPI3_0,@object
.LCPI3_0:
	.byte	1                               // 0x1
	.byte	2                               // 0x2
...
_RNvCs4tBK5thUKo0_3lib9neon_loop:       // @_RNvCs4tBK5thUKo0_3lib9neon_loop
	.cfi_startproc
// %bb.0:                               // %start
	lsr	x8, x1, #6
	cmp	x8, x3
