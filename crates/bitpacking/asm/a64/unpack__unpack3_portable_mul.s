bitpacking::unpack::unpack3_portable_mul:
	...
	mov x9, xzr
	umulh x11, x1, x10
	ldr q3, [x14, :lo12:.LCPI41_2]
	mov x14, x8
	umulh x10, x12, x10
	adrp x12, .LCPI41_0
	ldr q1, [x12, :lo12:.LCPI41_0]
	adrp x12, .LCPI41_1
	ldr q2, [x12, :lo12:.LCPI41_1]
	mov x12, x13
	lsr x11, x11, #2
	lsr x10, x10, #2
	add x11, x11, #1
...
.LBB41_24:
	adrp x3, .Lanon.bba673b6abbf1555a5789e1a894d50b2.17
	add x3, x3, :lo12:.Lanon.bba673b6abbf1555a5789e1a894d50b2.17
	mov x0, x9
	mov x2, x1
	bl core::slice::index::slice_index_fail
.LBB41_25:
	...
	adrp x2, .Lanon.bba673b6abbf1555a5789e1a894d50b2.16
	add x2, x2, :lo12:.Lanon.bba673b6abbf1555a5789e1a894d50b2.16
	mov w1, #105
...
.LBB41_26:
	...
	bl core::panicking::panic_fmt
.LBB41_27:
	adrp x3, .Lanon.bba673b6abbf1555a5789e1a894d50b2.15
	add x3, x3, :lo12:.Lanon.bba673b6abbf1555a5789e1a894d50b2.15
	mov x0, x9
	mov x2, x1
	bl core::slice::index::slice_index_fail
