bitpacking::byte_to_bit::bytes_to_bits_neon:
	str d10, [sp, #-48]!
	stp d9, d8, [sp, #16]
	stp x29, x30, [sp, #32]
	add x29, sp, #32
...
.LBB10_2:
	...
	uzp1 v5.16b, v1.16b, v2.16b
	uzp2 v1.16b, v1.16b, v2.16b
	uzp1 v2.16b, v3.16b, v4.16b
	uzp2 v3.16b, v3.16b, v4.16b
...
.LBB10_8:
	...
	dup v19.2d, x17
	add x16, x12, x8
	ldr q20, [x11, :lo12:.LCPI10_2]
	ldr q21, [x14, :lo12:.LCPI10_3]
	ldr q22, [x13, :lo12:.LCPI10_4]
	and x15, x1, #0xc
	and x11, x1, #0x30
	add x16, x16, #8
	and x17, x1, #0x30
...
.LBB10_12:
	movi v0.2d, #0000000000000000
	dup v3.2d, x11
	ldr q2, [x14, :lo12:.LCPI10_3]
	ldr q4, [x13, :lo12:.LCPI10_4]
	mov x15, x11
...
.LBB10_20:
	...
	b .LBB10_15
.LBB10_21:
	adrp x2, .Lanon.bba673b6abbf1555a5789e1a894d50b2.40
	add x2, x2, :lo12:.Lanon.bba673b6abbf1555a5789e1a894d50b2.40
	mov x1, x3
