...
.LBB14_8:
	...
	dup v19.2d, x17
	add x16, x12, x8
	ldr q20, [x11, :lo12:.LCPI14_2]
	ldr q21, [x14, :lo12:.LCPI14_3]
	ldr q22, [x13, :lo12:.LCPI14_4]
	and x15, x1, #0xc
	and x11, x1, #0x30
	add x16, x16, #8
	and x17, x1, #0x30
...
.LBB14_12:
	movi v0.2d, #0000000000000000
	dup v3.2d, x11
	ldr q2, [x14, :lo12:.LCPI14_3]
	ldr q4, [x13, :lo12:.LCPI14_4]
	mov x15, x11
...
.LBB14_20:
	...
	b .LBB14_15
.LBB14_21:
	adrp x2, .Lanon.bba673b6abbf1555a5789e1a894d50b2.43
	add x2, x2, :lo12:.Lanon.bba673b6abbf1555a5789e1a894d50b2.43
	mov x1, x3
