...
.LBB13_8:
	...
	and x11, x1, #0x30
	add x17, x13, x8
	ldr q20, [x12, :lo12:.LCPI13_2]
	ldr q21, [x15, :lo12:.LCPI13_3]
	ldr q22, [x14, :lo12:.LCPI13_4]
	and x16, x1, #0xc
	add x12, x10, x11
	add x17, x17, #8
	and x18, x1, #0x30
...
.LBB13_12:
	dup v3.2d, x11
	ldr q2, [x15, :lo12:.LCPI13_3]
	ldr q4, [x14, :lo12:.LCPI13_4]
	mov x16, x11
...
.LBB13_19:
	...
	ret
.LBB13_20:
	adrp x2, .Lanon.5a51297bb77c56467177fe203ad88db7.42
	add x2, x2, :lo12:.Lanon.5a51297bb77c56467177fe203ad88db7.42
	mov x1, x3
