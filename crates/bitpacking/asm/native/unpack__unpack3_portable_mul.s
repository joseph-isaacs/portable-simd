...
bitpacking::unpack::unpack3_portable_mul:
	...
	lea r9, [rdx + rdx + 6]
	xor edx, edx
	vmovdqa ymm0, ymmword ptr [rip + .LCPI60_0]
	vbroadcasti128 ymm1, xmmword ptr [rip + .LCPI60_5]
	vpbroadcastd xmm2, dword ptr [rip + .LCPI60_6]
	xor ebx, ebx
.LBB60_3:
	cmp r9, rdx
	je .LBB60_20
...
.LBB60_6:
	...
	shr rcx
	xor esi, esi
	vmovdqa64 zmm0, zmmword ptr [rip + .LCPI60_3]
	vpbroadcastd xmm1, dword ptr [rip + .LCPI60_6]
	jmp .LBB60_11
.LBB60_10:
	sub r9, r10
	inc rsi
...
.LBB60_20:
	lea rcx, [rip + .Lanon.7f2c312b5472e5928991000022678349.21]
	mov rdi, rdx
	mov rdx, rsi
	vzeroupper
	call qword ptr [rip + core::slice::index::slice_index_fail@GOTPCREL]
.LBB60_24:
	...
	lea rdx, [rip + .Lanon.7f2c312b5472e5928991000022678349.20]
	mov esi, 105
	vzeroupper
...
.LBB60_22:
	...
	call qword ptr [rip + core::panicking::panic_fmt@GOTPCREL]
.LBB60_18:
	lea rcx, [rip + .Lanon.7f2c312b5472e5928991000022678349.19]
	mov rdi, rdx
	mov rdx, rsi
	vzeroupper
	call qword ptr [rip + core::slice::index::slice_index_fail@GOTPCREL]
