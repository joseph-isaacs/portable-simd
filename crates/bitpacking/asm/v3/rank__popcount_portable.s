bitpacking::rank::popcount_portable:
	...
	vbroadcasti128 ymm4, xmmword ptr [rip + .LCPI11_5]
...
.LBB11_6:
	add rcx, rdi
	vpbroadcastd ymm2, dword ptr [rip + .LCPI11_4]
	vbroadcasti128 ymm3, xmmword ptr [rip + .LCPI11_5]
...
.LBB11_11:
	...
	vpxor xmm0, xmm0, xmm0
	xor esi, esi
	vmovdqa ymm1, ymmword ptr [rip + .LCPI11_2]
	vpbroadcastq ymm2, qword ptr [rip + .LCPI11_3]
	vpor ymm3, ymm3, ymm2
	vpcmpeqd ymm4, ymm4, ymm4
	vpbroadcastd ymm5, dword ptr [rip + .LCPI11_4]
	vbroadcasti128 ymm6, xmmword ptr [rip + .LCPI11_5]
