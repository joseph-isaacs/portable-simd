bitpacking::unpack::unpack3_portable_shift:
	...
	mov x9, xzr
	umulh x11, x1, x10
	ldr q3, [x13, :lo12:.LCPI46_2]
	mov x13, x8
	umulh x10, x12, x10
	adrp x12, .LCPI46_0
	ldr q1, [x12, :lo12:.LCPI46_0]
	adrp x12, .LCPI46_1
	ldr q2, [x12, :lo12:.LCPI46_1]
	mov x12, x15
	lsr x11, x11, #2
	lsr x10, x10, #2
	add x11, x11, #1
...
.LBB46_28:
	adrp x3, .Lanon.b051d2d6b7fd47aab34a8cc0381edb43.22
	add x3, x3, :lo12:.Lanon.b051d2d6b7fd47aab34a8cc0381edb43.22
	mov x0, x9
	mov x2, x1
	bl core::slice::index::slice_index_fail
.LBB46_29:
	...
	adrp x2, .Lanon.b051d2d6b7fd47aab34a8cc0381edb43.21
	add x2, x2, :lo12:.Lanon.b051d2d6b7fd47aab34a8cc0381edb43.21
	mov w1, #105
...
.LBB46_30:
	...
	bl core::panicking::panic_fmt
.LBB46_31:
	adrp x3, .Lanon.b051d2d6b7fd47aab34a8cc0381edb43.20
	add x3, x3, :lo12:.Lanon.b051d2d6b7fd47aab34a8cc0381edb43.20
	mov x0, x9
	mov x2, x1
	bl core::slice::index::slice_index_fail
