bitpacking::unpack::unpack3_neon:
	...
	adrp x9, .LCPI42_0
	adrp x11, .LCPI42_1
	ldr q1, [x9, :lo12:.LCPI42_0]
	ldr q2, [x11, :lo12:.LCPI42_1]
	mov x9, x15
	mov x11, x0
	mov x12, x8
.LBB42_3:
...
.LBB42_27:
	adrp x3, .Lanon.b051d2d6b7fd47aab34a8cc0381edb43.13
	add x3, x3, :lo12:.Lanon.b051d2d6b7fd47aab34a8cc0381edb43.13
	mov x0, x9
	mov x2, x1
	bl core::slice::index::slice_index_fail
