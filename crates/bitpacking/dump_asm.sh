...
FNS=(
  ...
  filter::filter_naive filter::filter_scalar filter::filter_portable filter::filter_portable_branchless filter::filter_portable4 filter::filter_bmi2 filter::filter_bmi2_branchless filter::filter_byte_lut filter::filter_vortex_lut filter::filter_vortex_pext
)
