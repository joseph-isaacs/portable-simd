...
FNS=(
  ...
  select::select_naive select::select_broadword select::select_portable select::select_pdep select::select_portable_scan_pdep
  filter::pext_hd
  filter::filter_naive filter::filter_scalar filter::filter_portable filter::filter_portable4 filter::filter_bmi2
)
