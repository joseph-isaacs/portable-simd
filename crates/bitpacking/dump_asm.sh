...
FNS=(
  ...
  indices::bitmap_to_indices_scalar indices::bitmap_to_indices_portable indices::bitmap_to_indices_avx2 indices::bitmap_to_indices_avx512
  ...
  expand::expand_naive expand::expand_scalar expand::expand_portable expand::expand_bmi2
  unpack::unpack3_scalar unpack::unpack3_portable_mul unpack::unpack3_portable_shift unpack::unpack3_pdep unpack::unpack3_avx2 unpack::unpack3_avx512
  filter::filter_naive filter::filter_scalar filter::filter_portable filter::filter_portable_branchless filter::filter_portable4 filter::filter_bmi2 filter::filter_bmi2_branchless filter::filter_byte_lut filter::filter_byte_lut_branchless filter::filter_vortex_lut filter::filter_vortex_lut_branchless filter::filter_vortex_pext
)
